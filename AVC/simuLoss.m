...
if nargin < 3   % NARGIN£ºNumber of function input arguments
    mode = 'default';
elseif nargin < 6
    loss_rate = 0.10;
end
...
if strcmp(mode, 'dispersed')    %TF = STRCMP(S1,S2) compares the strings S1 and S2 and returns logical 1(true) if they are identical, and returns logical 0 (false) otherwise.
